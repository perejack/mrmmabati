      ...
      <main className="flex-grow py-16">
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-maisha-navy mb-6 text-center">MRM MABATI MANUFACTURING PROCESS</h2>
            ...
            <div className="space-y-12">
              ...
              <div className="bg-gray-50 p-8 rounded-lg shadow">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    <img 
                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwosD11MNK0pbu2IaVJzSQVi7zX5XBmGygug&s" 
              ...
              <div className="bg-white p-8 rounded-lg shadow">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <img 
                      src="https://maishamabati.com/wp-content/uploads/2021/06/MAISHA-ROMAN-TILE-300x300.jpg" 
              ...
              <div className="bg-gray-50 p-8 rounded-lg shadow">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    <img 
                      src="https://imarishamabati.co.ke/wp-content/uploads/2018/11/Ridge-cap-2-570x570.jpg" 
              ...
              <div className="bg-white p-8 rounded-lg shadow">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <img 
                      src="https://maishamabati.com/wp-content/uploads/2021/06/Profiling-1024x683.jpg" 
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                <img 
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPefvkyhUYKF1sqqpQo9f1OsWAGH72vFJqjQ&s" 
