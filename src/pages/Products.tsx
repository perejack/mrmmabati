      ...
      <main className="flex-grow">
        ...
        <div className="relative h-48 md:h-72">
          <img 
            ...
            alt="MRM Mabati Rolling Mills Factory" 
            className="w-full h-full object-cover brightness-50"
          />
          <div className="absolute inset-0 flex items-center justify-center px-4 text-center">
            <h1 className="text-3xl md:text-5xl font-bold text-white">MRM MABATI PRODUCTS</h1>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-3xl mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-maisha-navy mb-4">MRM Mabati Products</h2>
